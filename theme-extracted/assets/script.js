...
// Scroll-reveal animation system — GPU-accelerated, 60 FPS
document.addEventListener('DOMContentLoaded', () => {
  if (!('IntersectionObserver' in window)) return;

  const revealElements = document.querySelectorAll('.lux-card, .lux-reveal');
  revealElements.forEach(el => el.classList.add('lux-reveal'));
